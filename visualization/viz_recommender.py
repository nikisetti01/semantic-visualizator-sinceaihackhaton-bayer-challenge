...
# LIDA Configuration
lida_text_gen = llm("openai", api_key=api_key)
lida = Manager(text_gen=lida_text_gen)
...
user_query = "Compare the safety observations made in 2024. How many regular maintenance requests were incorrectly reported as safety observations?"

# ---------------------------------------------------------
# STEP A: LIDA DATA PROFILING
# ---------------------------------------------------------
print("📊 Generating data profile with LIDA...")
# We use 'detailed' to give the LLM better context on value samples
summary = lida.summarize(df, summary_method="detailed")
summary_str = str(summary)

# ---------------------------------------------------------
# STEP B: ENHANCED SYSTEM PROMPT (With Semantic Decomposition)
# ---------------------------------------------------------
system_prompt = """
...
Provide 1-2 strong recommendations based on Part 1.
...
- **Visual Mapping (The Blueprint):**
    ...
    - *Color/Segment:* Column for segmentation.
...
# STEP C: API CALL
# ---------------------------------------------------------
print("🧠 Analyzing user query with GPT-4o-mini...")
...
response = client.chat.completions.create(
    ...
    temperature=0, # Kept very low to ensure strict adherence to the Mapping phase
)

text = response.choices[0].message.content

# Save text to file
output_path = "2chart_recommendation_enhanced.txt"
